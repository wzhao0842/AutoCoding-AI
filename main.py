...
'''
#may be old version? (legacy module)
...
print("Load Input Output Data")
Output = None
Input = None

with open("INPUT.Field", "rb") as f:
    Input = dill.load(f)

with open("OUTPUT.Field", "rb") as f:
    Output = dill.load(f)
...
def eng_to_python(src):
    ...
    # print(untokenize(translation[:-1]))
